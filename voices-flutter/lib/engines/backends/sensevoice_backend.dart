...
class SenseVoiceBackend implements EngineBackend {
  ...
  @override
  String get engineId => 'sensevoice_onnx';
  ...
  Future<String?> transcribePcm(Uint8List pcmData, int sampleRate) async {
    if (!isLoaded) {
      return 'Error: SenseVoice ONNX 模型未加载';
    }
